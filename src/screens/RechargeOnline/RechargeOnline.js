            ...
            <View style={{padding:10,backgroundColor:'white'}}>
                <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:10}}>
                    ...
                    <View style={{flexDirection:'row'}}>
                        <Text style={{color:'#0095D9',marginRight:5}}>123.568đ</Text>
                        <Icon name={'eye'} size={20} color={'#0095D9'} />
                    </View>
                </View>
                <Text style={{marginLeft:10,color:'#0095D9',fontSize:16}}>9686262868682826</Text>
