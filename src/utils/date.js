...
export function getDateString(date, format = 'DD-MM-yyyy HH:mm') {
  return moment(date, 'DD-MM-yyyy').format(format)
}

export function parseDateString(date, dateFormat = 'DD-MM-yyyy', format = 'DD-MM-yyyy HH:mm') {
  return moment(date, dateFormat).format(format)
}

export function convertToObjectData(date,format) {
...
export function convertBirth(date,format) {
