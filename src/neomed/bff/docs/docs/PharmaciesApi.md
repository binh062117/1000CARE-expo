...
var opts = { 
  ...
  'fromLastLogin': "fromLastLogin_example", // String | format yyyy-MM-ddT00:00:00Z
  'toLastLogin': "toLastLogin_example", // String | format yyyy-MM-ddT00:00:00Z
  'fromApproved': "fromApproved_example", // String | format yyyy-MM-ddT00:00:00Z
  'toApproved': "toApproved_example", // String | format yyyy-MM-ddT00:00:00Z
  'fromFirstLogin': "fromFirstLogin_example", // String | format yyyy-MM-ddT00:00:00Z
  'toFirstLogin': "toFirstLogin_example", // String | format yyyy-MM-ddT00:00:00Z
 ...
 **fromLastLogin** | **String**| format yyyy-MM-ddT00:00:00Z | [optional] 
 **toLastLogin** | **String**| format yyyy-MM-ddT00:00:00Z | [optional] 
 **fromApproved** | **String**| format yyyy-MM-ddT00:00:00Z | [optional] 
 **toApproved** | **String**| format yyyy-MM-ddT00:00:00Z | [optional] 
 **fromFirstLogin** | **String**| format yyyy-MM-ddT00:00:00Z | [optional] 
 **toFirstLogin** | **String**| format yyyy-MM-ddT00:00:00Z | [optional] 
...
> PresenterListPharmaciesResponse pharmacityControllerGetAllAccredit(distributorId, login, opts)
...
var login = true; // Boolean | true:have accredit false: haven't logged in for the first time.. default:true
...
apiInstance.pharmacityControllerGetAllAccredit(distributorId, login, opts, callback);
```
 ...
 **login** | **Boolean**| true:have accredit false: haven&#39;t logged in for the first time.. default:true | 
 **size** | **String**| Size of result set. Must be an integer | [optional] 
 **page** | **String**| Page number of view. Must be an integer | [optional] 
