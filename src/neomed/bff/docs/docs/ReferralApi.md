...
[**referralControllerApplyRefCode_0**](ReferralApi.md#referralControllerApplyRefCode_0) | **GET** /referral/backoffice/apply | 
...
<a name="referralControllerApplyRefCode_0"></a>
# **referralControllerApplyRefCode_0**
> PresenterApplyRefCodeResponse referralControllerApplyRefCode_0(ref, userId, opts)
...
var ref = "ref_example"; // String | ref code with prefix S (sale) or P (pharmacy)

var userId = 789; // Number | referred user id

var opts = { 
  'userPhone': "userPhone_example", // String | referred user phone
  'et': 56 // Number | referral event type (default = 1)
};
...
apiInstance.referralControllerApplyRefCode_0(ref, userId, opts, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ref** | **String**| ref code with prefix S (sale) or P (pharmacy) | 
 **userId** | **Number**| referred user id | 
 **userPhone** | **String**| referred user phone | [optional] 
 **et** | **Number**| referral event type (default &#x3D; 1) | [optional] 
